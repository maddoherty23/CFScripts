!function() {
    window.TICKET_GATOR = {
        init(t = "ticket-container") {
            const config = window.TICKET_CONFIG || {};
            this.teamId = config.teamId || "1";
            this.apiUrl = config.apiUrl || "https://madgator-f55ad62309d2.herokuapp.com";
            this.eventId = config.eventId || "1";
            this.ticketingConfig = config.ticketingConfig || "";
            ...
            this.r.style = "width:100%;height:850px;border:none";
        ...
        s() {
            this.r.contentWindow.postMessage({
                ...
                data: {
                    ...
                    ticketingConfig: this.ticketingConfig
                }
        ...
        async h(t) {
            ...
            if ("BOOKING_CREATED" === e) {
                console.log('🎫 Booking received:', i);
                this.i.style.display = "block";
                document.getElementById("bookingId").textContent = i.bookingId;
                
                try {
                    console.log('🎫 Processing booking:', i.bookingId);
                    const t = await fetch(`${this.apiUrl}/api/bookings/process`, {
                        method: "POST",
                    ...
                    console.log('✅ Booking processed:', i.bookingId);
